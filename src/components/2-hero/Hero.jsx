    ...
    return (
        <section className="hero" id='home'>
            <section className="content">
                ...
                <a className='btn' href="https://drive.google.com/drive/folders/1zSNIdJ17IcluOLLq58nJyBf5YouMnV_3?usp=sharing" target='_blank'>download cv <span className="icon-cloud-download"></span></a>
            </section>
